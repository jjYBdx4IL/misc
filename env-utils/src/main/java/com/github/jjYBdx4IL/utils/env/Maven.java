...
public class Maven extends JavaProcess {
    ...
    /**
     * Determine Maven build directory. This assumes the standard location and
     * has no knowledge of any reconfiguration happening in pom.xml or
     * elsewhere.
     * 
     * @param classRef
     ...
     * 
     * @param classRef
     *            see {@link Maven#getBasedir(Class)}. This parameter is also
     *            used to determine the last part of the temporary test
     *            directory.
     ...
     * {@link #getBasedirCpOnly(java.lang.Class) }. It tries to determine the
     * maven project's basedir by calling {@link Surefire#getMavenBasedir() }
     * first, and only using the classpath resolution if that fails.
     *
     * @param classRef
     *            only used if basedir determination by system properties only
     *            fails
