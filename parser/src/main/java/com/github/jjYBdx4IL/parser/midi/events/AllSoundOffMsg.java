...
//CHECKSTYLE:OFF
public class AllSoundOffMsg extends ChannelModeMsg {

    public static final int DATA1 = 120;
    public static final int DATA2 = 0;

    public AllSoundOffMsg(ShortMessage msg) {
        super(msg);
    }
    ...
    public String toString() {
        ...
        builder.append("AllSoundOffMsg [channel=");
