...
public class PolyphonicKeyPressureMsg extends PMidiMessage implements HasChannel {
     ...
     */
    public PolyphonicKeyPressureMsg(ShortMessage msg) {
    ...
    public static ShortMessage create(int channel, String note, int velocity) throws InvalidMidiDataException {
        return new ShortMessage(ShortMessage.POLY_PRESSURE, channel, PMidiMessage.toIntNote(note), velocity);
    }
    
    public static ShortMessage create(int channel, int note, int velocity) throws InvalidMidiDataException {
        return new ShortMessage(ShortMessage.POLY_PRESSURE, channel, note, velocity);
    }

    @Override
    public String toString() {
        StringBuilder builder = new StringBuilder();
        builder.append("PolyphonicKeyPressureMsg [channel=");
