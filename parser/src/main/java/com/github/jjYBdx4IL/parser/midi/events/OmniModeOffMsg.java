...
//CHECKSTYLE:OFF
public class OmniModeOffMsg extends ChannelModeMsg {

    public static final int DATA1 = 124;
    public static final int DATA2 = 0;
    
    public OmniModeOffMsg(ShortMessage msg) {
        super(msg);
    }
    ...
    public String toString() {
        ...
        builder.append("OmniModeOffMsg [channel=");
