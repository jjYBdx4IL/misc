...
//CHECKSTYLE:OFF
public class AllNotesOffMsg extends ChannelModeMsg {

    public static final int DATA1 = 123;
    public static final int DATA2 = 0;
    
    public AllNotesOffMsg(ShortMessage msg) {
        super(msg);
    }
