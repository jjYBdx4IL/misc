...
public class KeyPressRequest extends Request implements Serializable {
     ...
     * @return the instance
     */
    public static KeyPressRequest create(long seq, int keycode) {
        KeyPressRequest request = new KeyPressRequest();
        request.seq = seq;
